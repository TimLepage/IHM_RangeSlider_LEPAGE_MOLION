...
public class RangeSliderDemo extends JPanel {
    ...
    public RangeSliderDemo() {
        ...
        rangeSlider.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                ...
                rangeSliderValue2.setText(String.valueOf(slider.getSliderRight()));
            }
        });
    ...
    public void display() {
        ...
        rangeSlider.setSliderRight(7);
        
        // Initialize value display.
        rangeSliderValue1.setText(String.valueOf(rangeSlider.getValue()));
        rangeSliderValue2.setText(String.valueOf(rangeSlider.getSliderRight()));
